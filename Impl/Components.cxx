...
std::map<Type::T,     std::string_view> Component::TypeEnums
{
    {Type::Null,         "Null"},
    {Type::Number,       "Number"},
    {Type::Text,         "Text"},
...
std::string Component::MnemonicName(Mnemonic::T M)
{
    return std::string(Component::MnemonicEnums[M]);
}


Mnemonic::T Component::MnemonicEnum(const std::string &MName)
{
